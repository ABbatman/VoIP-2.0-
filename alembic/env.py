...
# Ensure project root (repo root) is importable for 'app' package during Alembic runs
PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)

# Import project metadata and async URL
from app.db.base import metadata as target_metadata  # shared MetaData
...
# Set SQLAlchemy URL dynamically from app config / async URL
